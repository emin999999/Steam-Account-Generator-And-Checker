...
print("Steam Account Premium Edition Generator And Checker 1.0")
import random
import string
import time
import requests
...
def check_account_validity(email, password):
    url = "https://steamcommunity.com/login/home/?l=turkish"
    headers = {
    ...
    if "Veri Akışı" in response.text:  # Buradaki metin giriş yapıldıktan sonraki bir elemanın adıdır, sizin durumunuzda farklı olabilir
        return True
    else:
        return False
